...
set_target_properties(unofficial::glib::glib PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/bin/glib-2.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS unofficial::glib::glib )
list(APPEND _IMPORT_CHECK_FILES_FOR_unofficial::glib::glib "${_IMPORT_PREFIX}/debug/lib/glib-2.0.lib" "${_IMPORT_PREFIX}/debug/bin/glib-2.dll" )
...
set_target_properties(unofficial::glib::gthread PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/bin/gthread-2.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS unofficial::glib::gthread )
list(APPEND _IMPORT_CHECK_FILES_FOR_unofficial::glib::gthread "${_IMPORT_PREFIX}/debug/lib/gthread-2.0.lib" "${_IMPORT_PREFIX}/debug/bin/gthread-2.dll" )
...
set_target_properties(unofficial::glib::gobject PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/bin/gobject-2.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS unofficial::glib::gobject )
list(APPEND _IMPORT_CHECK_FILES_FOR_unofficial::glib::gobject "${_IMPORT_PREFIX}/debug/lib/gobject-2.0.lib" "${_IMPORT_PREFIX}/debug/bin/gobject-2.dll" )
...
set_target_properties(unofficial::glib::gmodule PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/bin/gmodule-2.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS unofficial::glib::gmodule )
list(APPEND _IMPORT_CHECK_FILES_FOR_unofficial::glib::gmodule "${_IMPORT_PREFIX}/debug/lib/gmodule-2.0.lib" "${_IMPORT_PREFIX}/debug/bin/gmodule-2.dll" )
...
set_target_properties(unofficial::glib::gio PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/debug/bin/gio-2.dll"
  )

list(APPEND _IMPORT_CHECK_TARGETS unofficial::glib::gio )
list(APPEND _IMPORT_CHECK_FILES_FOR_unofficial::glib::gio "${_IMPORT_PREFIX}/debug/lib/gio-2.0.lib" "${_IMPORT_PREFIX}/debug/bin/gio-2.dll" )
