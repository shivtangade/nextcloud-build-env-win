...
!define APPLICATION_SHORTNAME "sprycloud"
!define APPLICATION_NAME "spryCloud"
!define APPLICATION_VENDOR "Spry Servers, LLC"
!define APPLICATION_EXECUTABLE "sprycloud.exe"
!define APPLICATION_CMD_EXECUTABLE "sprycloudcmd.exe"
!define APPLICATION_DOMAIN "www.spryservers.net"
!define APPLICATION_LICENSE ""
!define WIN_SETUP_BITMAP_PATH "C:\Users\TabFitts\SpryDev\sprycloud-client-next\admin\win\nsi"

!define CRASHREPORTER_EXECUTABLE "sprycloud_crash_reporter"
...
; Some paths.
;-----------------------------------------------------------------------------
!define BUILD_PATH "C:\Users\TabFitts\SpryDev\sprycloud-client-next\build"
!define SOURCE_PATH "C:\Users\TabFitts\SpryDev\sprycloud-client-next"
!define BIN_OUT_PATH "C:\Users\TabFitts\SpryDev\install\bin"
...
;   ${If} ${RunningX64}
;      ExecWait '"$OUTDIR\vc_redist.x64.exe" /install /quiet'
;   ${Else}
...
Section "${APPLICATION_NAME}" SEC_APPLICATION
   ...
   CreateDirectory "$INSTDIR\${APPLICATION_SHORTNAME}"
   CreateDirectory "$INSTDIR\styles"
   CreateDirectory "$INSTDIR\translations"
   
   SetOutPath "$INSTDIR\bearer"
   File "${BIN_OUT_PATH}\bearer\*"
   SetOutPath "$INSTDIR\iconengines"
   File "${BIN_OUT_PATH}\iconengines\*"
   SetOutPath "$INSTDIR\imageformats"
   File "${BIN_OUT_PATH}\imageformats\*"
   SetOutPath "$INSTDIR\platforms"
   File "${BIN_OUT_PATH}\platforms\*"
   SetOutPath "$INSTDIR\position"
   File "${BIN_OUT_PATH}\position\*"
   SetOutPath "$INSTDIR\printsupport"
   File "${BIN_OUT_PATH}\printsupport\*"
   SetOutPath "$INSTDIR\resources"
   File "${BIN_OUT_PATH}\resources\*"
   SetOutPath "$INSTDIR\${APPLICATION_SHORTNAME}"
   File "${BIN_OUT_PATH}\${APPLICATION_SHORTNAME}\*"
   SetOutPath "$INSTDIR\styles"
   File "${BIN_OUT_PATH}\styles\*"
   SetOutPath "$INSTDIR\translations"
   File "${BIN_OUT_PATH}\translations\*" 
 
   SetOutPath "$INSTDIR"
   ;License & release notes.
   File "C:\Program Files\CMake\share\cmake-3.12\Templates\CPack.GenericLicense.txt"
